...
extension FMViewController {
    func round5() {
        ...
        let mask4 = addMaskView(startingPoint: .Right, y: 240, mask: 4)
        ...
        let mask10 = addMaskView(startingPoint: .Right, y: 660, mask: 4)
        ...
        let mask15 = addMaskView(startingPoint: .Right, y: 225, mask: 4)
        ...
        let mask18 = addMaskView(startingPoint: .Left, y: 375, mask: 1)
        addTransformTo(mask: mask18, startingPoint: .Left, duration: 5, delay: 2)
        
        let mask19 = addMaskView(startingPoint: .Right, y: 425, mask: 4)
        addTransformTo(mask: mask19, startingPoint: .Right, duration: 6, delay: 1)
        
        let mask20 = addMaskView(startingPoint: .Right, y: 475, mask: 2)
